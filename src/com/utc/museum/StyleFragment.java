...
public class StyleFragment extends DetailsFragment {	
	...
	private TextView mNomStyle;
	private TextView mDescription;
	private TextView mArtistes;
	private TextView mLegende;
	private TextView mEpoque;
	...
	private View v;
	private ArrayList<Style> mAlData;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		v = inflater.inflate(R.layout.style_fragment, container, false);
		v.setDrawingCacheEnabled(false);
		mNomStyle = (TextView) v.findViewById(R.id.titre_image);
		mArtistes = (TextView) v.findViewById(R.id.artistes);
		mLegende = (TextView) v.findViewById(R.id.legende);
		mDescription = (TextView) v.findViewById(R.id.description);
		mEpoque = (TextView) v.findViewById(R.id.epoque);
     ...
     */	
	public static StyleFragment newInstance(int menuIndex, String oeuvre) {
		// Instanciation d'un nouveau fragment
		StyleFragment detail = new StyleFragment();
	...
	private void updateUiTexte() {
		if (mAlData != null) {
    		mNomStyle.setText(mAlData.get(0).getNom());
    		mArtistes.setText(Html.fromHtml("<u>" + getString(R.string.artistes) + " :</u>" + " " + mAlData.get(0).getArtistes()));
    		mLegende.setText(mAlData.get(0).getDescriptionVisuel());
 			mDescription.setText(mAlData.get(0).getDescription());
 			mEpoque.setText(mAlData.get(0).getEpoque());
			...
			builder.setMessage(getString(R.string.erreur_chargement_style))
	...
	private class DownloadDataTask extends AsyncTask<String, Void, ArrayList<? extends Entry>> {
		protected void onPreExecute() {
	     ...
	     protected ArrayList<? extends Entry> doInBackground(String... urls) {
			mAlData = ContainerData.getStyles(urls[0]);
	        return mAlData;
	     }
